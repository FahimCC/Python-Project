...
IFontDisp = Font
__all__ = [ 'FONTBOLD', 'OLE_XSIZE_CONTAINER', 'OLE_XPOS_CONTAINER',
           'LoadPictureConstants', 'OLE_XSIZE_HIMETRIC', 'OLE_HANDLE',
           'Picture', 'OLE_YSIZE_CONTAINER', 'Checked', 'IPicture',
           'IFontEventsDisp', 'FONTSTRIKETHROUGH', 'OLE_OPTEXCLUSIVE',
           'OLE_YPOS_CONTAINER', 'IFontDisp', 'StdFont', 'FontEvents',
           'FONTSIZE', 'FONTUNDERSCORE', 'OLE_XPOS_HIMETRIC',
           'Unchecked', 'Color', 'OLE_XPOS_PIXELS', 'Font',
           'OLE_YSIZE_PIXELS', 'OLE_COLOR', 'OLE_YPOS_HIMETRIC',
           'IFont', 'OLE_YSIZE_HIMETRIC', 'Default', 'VgaColor',
           'Monochrome', 'OLE_XSIZE_PIXELS', 'FONTITALIC', 'FONTNAME',
           'Gray', 'OLE_TRISTATE', 'OLE_ENABLEDEFAULTBOOL',
           'StdPicture', 'OLE_YPOS_PIXELS', 'OLE_CANCELBOOL',
           'IPictureDisp']
